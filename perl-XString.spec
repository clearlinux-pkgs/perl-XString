...
Source0  : https://cpan.metacpan.org/authors/id/A/AT/ATOOMIC/XString-0.004.tar.gz
...
%prep
%setup -q -n XString-0.004
cd %{_builddir}/XString-0.004
...
cp %{_builddir}/XString-0.004/LICENSE %{buildroot}/usr/share/package-licenses/perl-XString/bd01b61740795eaefc30a3d7ce4bc6de6b114892
if test -f Makefile.PL; then
